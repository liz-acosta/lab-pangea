...
from .views import (
    ...
    RestorePasswordView, RestorePasswordDoneView, RestorePasswordConfirmView, MessageSendView, MessagesView, MessageView,
)
...
urlpatterns = [
    ...
    path('message/<message_id>', MessageView.as_view(), name='message'),
]
